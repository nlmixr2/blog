...
In the PowerPoint deck the same table is written as Office Math,
which PowerPoint reads.  It has no fallback image, though, so
LibreOffice Impress and some other viewers show the equations slide
blank.

...
To reproduce the (https://github.com/nlmixr2/nmtests/)[nmtests] in the
...
(https://github.com/nlmixr2/nmtests/)[nmtests] with a few more tests
cases).

## Steady State with Lag time

We will show the first difference we saw in the (https://github.com/nlmixr2/nmtests/)[nmtests]:
...
example, from the (https://github.com/nlmixr2/nmtests/)[nmtests]
dataset:
...
(https://github.com/nlmixr2/nmtests/)[nmtests].

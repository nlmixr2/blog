---
title: nlmixr2/rxode2 more user functions
...
This month, I will talk about a new type of user function that extends
`nlmixr2`/`rxode2` by allowing certain functions to generate code.

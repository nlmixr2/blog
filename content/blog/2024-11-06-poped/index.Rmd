...
library(babelmixr2)
```
# babelmixr2 was released on CRAN today supporting PopED integration
...
- Attend our or our nlmixr2 tutorial on Thursda (Using Past Models to Bridge to
  Open Models and Open Science using nlmixr2) if you want to talk

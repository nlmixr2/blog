...
DECK   = pathlib.Path(__file__).with_name("pharmacometrics-in-r.html")
...
SAY = [
    # R package / function names in the pharmacometrics-in-r deck.  UNMEASURED
    # against ElevenLabs -- verify with Scribe before a real take.
    (r"\bnlmixr2lib\b",       "N L mixer two lib"),
    (r"\bbabelmixr2\b",       "babel mixer two"),
    (r"\bnonmem2rx\b",        "NONMEM to R X"),
    (r"\bmonolix2rx\b",       "Monolix to R X"),
    (r"\bggplot2\b",          "G G plot two"),
    (r"\bdplyr\b",            "D plier"),
    (r"\brenv\b",             "R env"),
    (r"\brxSolve\b",          "R X solve"),
    (r"\bRtools\b",           "R tools"),
    (r"\bPKNCA\b",            "P-K-N-C-A"),
    (r"\bPopED\b",            "Pop E D"),
    (r"\bvae\b",              "V-A-E"),
    (r"\bphi0\b",            "phi zero"),

...
While this showed 2 different extra geoms you can use with your own
analysis, you can also use the `rxTheme()` ggplot theme with other
ggplot objects (or apply your own theme to the ggplot objects
generated from `rxode2`).

I chose to highlight this because I don't believe that these are
currently very well known and can both be useful depending on your
analysis.

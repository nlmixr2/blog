...
`pmxNODE`) to `rxode2`/`nlmixr2`, linear model expansions or other
similar sorts of functions.

If are not interested in the details for using this directly in your
...
- [`babelmixr2`](https://nlmixr2.github.io/babelmixr2/) generates
  ...
  model (as well as `NONMEM`/`Monolix` model imports)
...
Now, back to adding new user functions that generate code in nlmixr2.
